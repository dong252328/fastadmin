<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"E:\phpStudy\PHPTutorial\WWW\origin\fastadmin\public/../application/index\view\user\login.html";i:1530866246;s:87:"E:\phpStudy\PHPTutorial\WWW\origin\fastadmin\application\index\view\layout\default.html";i:1531195280;s:84:"E:\phpStudy\PHPTutorial\WWW\origin\fastadmin\application\index\view\common\meta.html";i:1530866246;s:86:"E:\phpStudy\PHPTutorial\WWW\origin\fastadmin\application\index\view\common\script.html";i:1530866246;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<link rel="shortcut icon" href="/origin/fastadmin/public/assets/img/favicon.ico" />
<!-- Loading Bootstrap -->
<link href="/origin/fastadmin/public/assets/css/frontend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">

<!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
<!--[if lt IE 9]>
  <script src="/origin/fastadmin/public/assets/js/html5shiv.js"></script>
  <script src="/origin/fastadmin/public/assets/js/respond.min.js"></script>
<![endif]-->
<script type="text/javascript">
    var require = {
        ...
        <link href="/origin/fastadmin/public/assets/css/user.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">
    </head>
...
<script type="text/html" id="resetpwdtpl">
    <form id="resetpwd-form" class="form-horizontal form-layer" method="POST" action="<?php echo url('api/user/resetpwd'); ?>">
        ...
        <script src="/origin/fastadmin/public/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/origin/fastadmin/public/assets/js/require-frontend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script>
